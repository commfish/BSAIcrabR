...
#' @param ft_data NULL. Fish ticket data with fields 'crab_year', 'fishery', 'effort'.
...
#' @export
#'
get_total_catch <- function(data, stock, by, lump = T, units = "t") {
  ...
  crab_data %>%
    ...
    get_avg_wt(., stock = stock, by = by, lump = lump, units = units) -> avg_wt
